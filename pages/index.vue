  ...
  <main>
    <section class="flex justify-start items-center gap-5">
      <div class="flip-container">
        <div class="rounded-full border-2 border-zinc-600 flipper">
          <NuxtImg
            ...
            width="70"
            height="70"
            class="rounded-full p-0.5 flipping-image"
          />
        </div>
      </div>
      <div>
        <h1 class="text-2xl font-medium tracking-tighter text-white">
          Hey, I'm James 👋
        </h1>
        <div class="flex justify-between pt-1">
          <div class="flex items-center gap-2">
            ...
            <p
              class="underline decoration-dashed underline-offset-4 decoration-zinc-700 text-sm text-gray-400"
            >
              Available for work
            </p>
          </div>
      ...
      <!-- <div class="text-xs flex items-end gap-2 mt-2">
        <NuxtLink
    ...
    <section class="py-5">
      <p class="text-white text-md">
        ...
        design, crafting and engaging responsive user-friendly experiences with
